//! slides_helper — Builds XML fragments and assets used in slide generation.
...
pub fn single_slide_content_types() -> String {
    r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
pub fn multi_slide_content_types(slide_count: usize) -> String {
...
<Override PartName="/ppt/slideMasters/slideMaster1.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slideMaster+xml"/>
<Override PartName="/ppt/slideLayouts/slideLayout1.xml" ContentType="application/vnd.openxmlformats-officedocument.presentationml.slideLayout+xml"/>
<Override PartName="/ppt/theme/theme1.xml" ContentType="application/vnd.openxmlformats-officedocument.theme+xml"/>"#.to_string();
...
pub fn single_slide_presentation() -> String {
    r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
...
pub fn single_slide_presentation_rels() -> String {
    r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
...
pub fn slide(title: &str, body: &str) -> String {
...
pub fn core_properties(date: &str) -> String {
    format!(
        r#"<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
