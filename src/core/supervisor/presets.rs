...
pub fn preset_agent_defs() -> Vec<NLAgentDef> {
    vec![
        ...
        NLAgentDef {
            ...
            model: "gpt-4o".into(),
            tools: vec!["file_ops".into(), "read_file".into(), "write_file".into(), "compress".into()],
            knowledge: vec!["file_formats".into(), "compression_methods".into()],
            skills: vec!["file_management".into(), "format_conversion".into(), "batch_processing".into()],
            memory: vec![],
            persona_config: NLPersonaConfig::default(),
            communication_style: "professional".into(),
            suggestions: vec![],
        ...
        NLAgentDef {
            name: "系统助手".into(),
            persona: "你是一个系统管理助手，擅长系统信息查询、进程监控、性能分析和故障排查。".into(),
            model: "gpt-4o".into(),
            tools: vec!["system_info".into(), "process_monitor".into(), "disk_usage".into(), "network_check".into()],
            knowledge: vec!["system_administration".into(), "performance_tuning".into()],
            skills: vec!["system_diagnostics".into(), "performance_analysis".into(), "troubleshooting".into()],
            memory: vec![],
            persona_config: NLPersonaConfig::default(),
            communication_style: "professional".into(),
            suggestions: vec![],
        ...
        NLAgentDef {
            ...
            model: "gpt-4o".into(),
            tools: vec!["draft".into(), "proofread".into(), "format_doc".into(), "translate".into()],
            knowledge: vec!["writing_style_guides".into(), "document_templates".into()],
            skills: vec!["content_writing".into(), "document_formatting".into(), "copy_editing".into()],
            memory: vec![],
            persona_config: NLPersonaConfig::default(),
            communication_style: "professional".into(),
            suggestions: vec![],
