...
impl AgentAssembler {
    ...
    pub fn assemble(&self, def: AgentDef) -> Result<Box<dyn Component>, String> {
        ...
        impl Component for AssembledAgent {
            ...
            fn health_check(&self) -> crate::core::component::HealthStatus { crate::core::component::HealthStatus::Healthy }
        }

        impl crate::core::component::IOComponent for AssembledAgent {
            fn ports(&self) -> Vec<crate::core::component::Port> {
                vec![
                    crate::core::component::Port { id: "input".into(), direction: crate::core::component::PortDirection::Input, data_type: "text".into(), description: "user input".into() },
                    crate::core::component::Port { id: "output".into(), direction: crate::core::component::PortDirection::Output, data_type: "text".into(), description: "agent response".into() },
                ]
            }
            fn send(&mut self, _port: &str, _data: crate::core::component::Data) -> Result<(), String> { Ok(()) }
            fn recv(&mut self, _port: &str) -> Result<Option<crate::core::component::Data>, String> { Ok(None) }
        }

        impl crate::core::component::SecureComponent for AssembledAgent {
            fn required_permissions(&self) -> Vec<crate::core::component::Permission> { vec![] }
        }

        Ok(Box::new(AssembledAgent { id: agent_id, name: _agent_name }))
    }

    pub fn natural_language_build(description: &str) -> Result<AgentDef, String> {
        let desc_lower = description.to_lowercase();
        let (persona, persona_id) = if desc_lower.contains("biology") || desc_lower.contains("research") || desc_lower.contains("science") {
            (crate::component::persona::create_researcher_persona(), "researcher")
        } else if desc_lower.contains("write") || desc_lower.contains("content") || desc_lower.contains("blog") {
            (crate::component::persona::create_writer_persona(), "writer")
        } else if desc_lower.contains("code") || desc_lower.contains("program") || desc_lower.contains("develop") {
            (crate::component::persona::create_coder_persona(), "coder")
        } else if desc_lower.contains("analyst") || desc_lower.contains("analyze") || desc_lower.contains("data") {
            (crate::component::persona::create_analyst_persona(), "analyst")
        } else {
            (crate::component::persona::create_assistant_persona(), "assistant")
        };
        ...
        Ok(AgentDef {
            ...
            name: description.split(|c: char| !c.is_alphanumeric() && c != ' ')
